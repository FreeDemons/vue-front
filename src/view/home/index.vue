    ...
    <svg xmlns="http://www.w3.org/2000/svg"
      ...
      <defs>
        <pattern id='image'
          ...
          <image xlink:href="https://s3-us-west-2.amazonaws.com/s.cdpn.io/78881/pattern_141.gif"
                 width="100"
                 height="100"
            ...
            <var class="translate3d">
              <var class="translate3d-1">
                <figure class="butterfly">
                  <svg class="wing left icon shape-codepen"
                       viewBox="0 0 50 100">
                    <use class="left"
                         xlink:href="#shape-butterfly-1"></use>
                  </svg>
                  <svg class="wing right icon shape-codepen"
                       viewBox="0 0 50 100">
                    <use class="left"
                         xlink:href="#shape-butterfly-1"></use>
                  </svg>
...
<script>
import WebRecord from './component/WebRecord.vue'
export default {
  components: { WebRecord },
  mounted () {
  }
}
</script>
